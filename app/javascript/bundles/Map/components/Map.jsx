...
export default class Map extends Component {
  ...
  handleSwitchChange = event => {
    ...
    document
      ...
      .classList.toggle("instructions-hidden");
  };
      ...
      this.directions.on("route", () => {
        ...
        if (!this.state.waypointJustAdded) {
          ...
          const [
            originLng,
            originLat
          ] = this.directions.getOrigin().geometry.coordinates;
          const [
            destinationLng,
            destinationLat
          ] = this.directions.getDestination().geometry.coordinates;
    ...
    new mapboxgl.Popup()
      ...
      .setHTML(
        `<div className="station-pop">
          ...
          <button onclick="window.map.addWaypoint(${coordinates[0]}, ${
          coordinates[1]
        })">
            Set Waypoint
          </button>
          <button onclick="window.map.chargeUp(${coordinates[0]}, ${
          coordinates[1]
        })">
            Reset Range
          </button>
